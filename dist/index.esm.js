...
import { DragSource, DropTarget, createDndContext, DndContext, DndProvider } from 'react-dnd';
import React, { Component, Children, cloneElement, useRef } from 'react';
...
var ReactSortableTree = /*#__PURE__*/function (_Component) {
  ...
  _createClass(ReactSortableTree, [{
    ...
    value: function renderRow(row, _ref9) {
      ...
      }, sharedProps, nodeProps)), hasEndStaff || /*#__PURE__*/React.createElement(React.Fragment, null, " "));
    }
  }, {
    key: "render",
    value: function render() {
